...
if not game:IsLoaded() then
	...
	notLoaded.Text = 'Infinite Yield Edited is waiting for the game to load'
	game.Loaded:Wait()
	notLoaded:Destroy()
end
...
Title.TextSize = 18
Title.Text = "Infinite Yield Edited"
...
Credits.Text = "Edited by Nicuse#6163"
...
SaveChatlogs.MouseButton1Down:Connect(function()
	if writefileExploit() then
		if #scroll_2:GetChildren() > 0 then
			...
			local writelogs = '-- Infinite Yield Edited Chat logs for "'..placeName..'"\n'
			for _, child in pairs(scroll_2:GetChildren()) do
				writelogs = writelogs..'\n'..child.Text
			end
...
CMDs[#CMDs + 1] = {NAME = 'loopjump / lj', DESC = 'Makes your character jump (Custom)'}
CMDs[#CMDs + 1] = {NAME = 'unloopjump / unlj', DESC = 'Unloops jump (Custom)'}
CMDs[#CMDs + 1] = {NAME = 'lesslag / lagreducer', DESC = 'Reduces lag / boosts fps (Custom)'}
CMDs[#CMDs + 1] = {NAME = 'bypassedfly (r15 only)', DESC = 'Bypassed fly for games like da hood (Custom)'}
CMDs[#CMDs + 1] = {NAME = 'unbypassedfly (r15 only)', DESC = 'Bypass unfly (Custom)'}
...
CMDs[#CMDs + 1] = {NAME = 'fixeddex / fixedexplorer / oldexplorer / olddex [waypoint]', DESC = 'Opens the old dex v2.0 by raspberry pi (Custom)'}
...
CMDs[#CMDs + 1] = {NAME = 'scripthub / openscripthub / ezhub', DESC = 'Opens EZ Hub (Custom)'}
CMDs[#CMDs + 1] = {NAME = 'joinsmallestserver / jss', DESC = 'Joins smallest server (Custom)'}
if game.PlaceId == 5602055394 then
	CMDs[#CMDs + 1] = {NAME = 'bypassanticheat / bpa', DESC = 'Bypass Hood Modded Anticheat (Custom)'}
end
wait()
...
Players.LocalPlayer.OnTeleport:Connect(function(State)
	if State == Enum.TeleportState.Started then
		if KeepInfYield and queueteleport then
			queueteleport("loadstring(game:HttpGet('https://raw.githubusercontent.com/Nicuse/RobloxScripts/main/InfiniteYieldEdited.lua'))()")
		end
	end
end)
...
addcmd('joinsmallestserver',{'jss'},function(args,speaker)
...
RunService.RenderStepped:Connect(function()
    if Loopjump == true then
        game.Players.LocalPlayer.Character.Humanoid.Jump = true
    end
end)

addcmd('loopjump',{'lj'},function(args, speaker)
    Loopjump = true
end)

addcmd('unloopjump',{'unlj'},function(args, speaker)
    Loopjump = false
end)
...
if game.PlaceId == 5602055394 then
	addcmd('bypassanticheat',{'bpa'},function(args, speaker)
...
addcmd('fixeddex',{'fixedexplorer', 'oldexplorer', 'olddex'}, function(args, speaker)
    local request=http_request or request or (syn and syn.request) or (http and http.request)
    loadstring(request({Url="https://cdn.discordapp.com/attachments/944941820373270528/982349222143721472/dex_v3.lua",Method="GET"}).Body)()
end)
...
addcmd('scripthub',{'openscripthub', 'ezhub'}, function(args, speaker)
	loadstring(game:HttpGet(('https://raw.githubusercontent.com/debug420/Ez-Industries-Launcher-Data/master/Launcher.lua'),true))()
end)

addcmd('lesslag',{'lagreducer'}, function(args, speaker)
